...
#include "ng.h"
/* Rebuild a fresh Make Target run. Revision 3..5 accepts legacy 1..1000;
 * revision 6 accepts 10/24/50/100/200/NG_TARGET_RANDOM. The requested policy
 * and resolved target remain separate. Invalid arguments leave every byte
 * unchanged. Do not call to edit a live run. */
